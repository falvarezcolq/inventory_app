  ...
  export default {
    ...
    methods:{
        ...
        async MotivoTramite() {
            ...
            this.tramite.id_tramite = '';
            let data = {params:this.params};
            let result = await api.get(`/getMotivoTramiteTvf/${this.tramite.cod_tiempo}`, data)
            .then((response) => {
        ...
        async ObtenerTramite(){     
            this.tramite.id_tramite = '';
            let data = {params:this.params};
            let result = await api.get(`/getTramiteTvf/${this.tramite.cod_tiempo}/${this.tramite.cod_motivo}`,data).then((response) => {
