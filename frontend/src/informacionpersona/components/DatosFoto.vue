<template>
  <div>
    <div class="containter-img mb-2">
      <img class="user" v-bind:src="foto_perfil" alt="Imagen de perfil" v-if = "foto_perfil" style="width: 100%;">
      <img class="user" :src="require('@/assets/perfil.png')" alt="Your Image" v-else style="width: 100%;">
    </div>
    
    <label for="file-upload-perfil" class="btn btn-sm btn-outline-success w-100" >
    ...
    <label class="orange">**Foto con fondo blanco</label>
